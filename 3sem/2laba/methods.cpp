...
void printAllMatrix(std::vector<std::shared_ptr<Matrix>> &matrixArray)
{
    int i = 1;
...
void menuMatrux(std::vector<std::shared_ptr<Matrix>> &matrixArray)
{
    ...
    case 1: //+
    {
        ...
        if (isEqualDimension(*(matrixArray[matrix1 - 1]), *(matrixArray[matrix2 - 1])))
        {
            *result = *(matrixArray[matrix1 - 1]) + *(matrixArray[matrix2 - 1]);
            matrixArray.push_back(std::shared_ptr<Matrix>(result));
        }
        else
...
void menu()
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            std::cin >> (*newObject);
            matrixArray.push_back(newObject);
            break;
        }
        case 2:
        {
        ...
        {
            printAllMatrix(matrixArray);
            std::cout << "\nEnter number of deleting matrix: ";
            int matrixDel;
            inputNumOfMatrix(matrixDel, matrixArray.size());
            matrixArray.erase(matrixArray.begin() + matrixDel);
            break;
        }
        case 4:
        {

...
void Time::setTime(const int hours, const int minutes)
{
    this->hours = hours;
    this->minutes = minutes;
}
...
Date::Date(const int days, const int months, const int years)
{
    this->days = days;
    this->months = months;
    this->years = years;
...
void Date::setData(const int days, const int months, const int years)
{
    this->days = days;
    this->months = months;
    this->years = years;
...
Day::Day(const int hours, const int minutes, const int days, const int months, const int years)
{
...
Meeting::Meeting(const int hours, const int minutes, const int days, const int months, const int years, const std::string status) : Day(hours, minutes, days, months, years)
{
    uid = count;
    this->status = status;
}
...
Task::Task(const int hours, const int minutes, const int days, const int months, const int years, const std::string status) : Day(hours, minutes, days, months, years)
{
    uid = count;
    this->status = status;
    if (status == "Completed")
...
void Task::congratulations() const
{
    std::cout << "I do not know what additional message should be displayed when performing tasks, but let it be it\n";
}

Reminder::Reminder(const int hours, const int minutes, const int days, const int months, const int years, const std::string message) : Day(hours, minutes, days, months, years)
{
    uid = count;
